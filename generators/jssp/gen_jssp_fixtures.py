...
JSSP_INSTANCES = [
    ...
    # Lawrence instances (smaller, diverse) - canonical Lawrence (1984) data
    ("la01", 10, 5, 666, [
    ...
    # Applegate & Cook (ORB) instances - canonical Bill Cook BIC2 data
    ("orb01", 10, 10, 1059, [
...
def main():
    # Repo layout: generators/jssp/gen_jssp_fixtures.py -> repo_root/mips
