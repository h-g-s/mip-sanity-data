...
def solve_qap_external(n, f, d, timeout=60):
    """Solve the linearized MPS with mipster to get a certified optimal
    value; returns (obj, status) where status is "optimal", "timelimit",
    or an error string."""
    import re
    import subprocess
    import tempfile
...
def main():
    ...
    # Repo layout: generators/qap/gen_qap_fixtures.py -> repo_root/mips
